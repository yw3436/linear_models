...
borough variable is a character variable. In regression and in ggplot,
it automatically converts to a factor variable, so Bronx is always the
reference.
...
```
    ...
    ## 
    ## Call:
    ## lm(formula = price ~ stars * borough + room_type * borough, data = nyc_airbnb)
    ## 
    ## Coefficients:
    ##                           (Intercept)                                  stars  
    ##                                95.694                                 27.110  
...
```
    ...
    ##   <chr>       <dbl>  <dbl>    <dbl>     <dbl>
    ## 1 (Intercept) 49.9    18.1    -11.3     -34.3
    ## 2 stars        4.91   15.8     28.0      43.3
